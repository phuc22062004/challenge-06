...
const deployedContracts = {
  11155111: {
    DEX: {
      address: "0x6Ed4E69A6767A32b8d14beaEfbC60b0340E50F0A",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9955830,
    },
    MyUSD: {
      address: "0xd19902bcDC777993F08a46aF1aF7086C7d0B1D48",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9955829,
    },
    MyUSDEngine: {
      address: "0x8C3BA03f87Cff9F3571d28c178f81e1882A40746",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9955833,
    },
    MyUSDStaking: {
      address: "0x672164d5fB46fBc051b3Fd552a9a37A3f02f0862",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9955832,
    },
    Oracle: {
      address: "0x4746E8AD021eeF5fe997DdA6D81439ae006211Ce",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9955831,
    },
    RateController: {
      address: "0xB93386e2a94238b4B8Fa5413eE8EeBcf3618edB9",
      abi: [
        {
          inputs: [
            {
